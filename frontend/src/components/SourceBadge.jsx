// Shared source icons, config, labels, and SourceBadge component.
// Used across Pipeline, Leads, Deals pages and their detail panels.
...
// Official Google "G" multicolor logo — uses explicit fill colors, not currentColor
...
export const WebsiteIcon = ({ size = 14 }) => (
...
export const EmailIcon = ({ size = 14 }) => (
...
export const PhoneCallIcon = ({ size = 14 }) => (
...
export const ReferralIcon = ({ size = 14 }) => (
...
export const EventIcon = ({ size = 14 }) => (
...
export const PartnerIcon = ({ size = 14 }) => (
...
export const SocialMediaIcon = ({ size = 14 }) => (
...
export const WalkInIcon = ({ size = 14 }) => (
...
export const OtherIcon = ({ size = 14 }) => (
...
export const SOURCE_LABELS = {
  ...
  // legacy keys from older records
  call: "Cold Call", email: "Email", social: "Social Media", exhibition: "Event/Conference",
};
...
export function SourceBadge({ source }) {
  ...
  return (
    <span style={{
      ...
      borderRadius: 99, background: `${color}12`, color,
      border: `1px solid ${color}28`, width: "fit-content",
      whiteSpace: "nowrap",
    }}>
      {Icon && <Icon size={14} />}
      {label}
